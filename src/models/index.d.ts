...
export declare class UberUser {
  ...
  constructor(init: ModelInit<UberUser, UberUserMetaData>);
  static copyOf(source: UberUser, mutator: (draft: MutableModel<UberUser, UberUserMetaData>) => MutableModel<UberUser, UberUserMetaData> | void): UberUser;
}
